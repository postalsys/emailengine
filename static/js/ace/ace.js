(function () {
    ...
    define(
        'ace/lib/app_config',
        ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/event_emitter', 'ace/lib/report_error', 'ace/lib/default_english_messages'],
        function (e, t, n) {
            'no use strict';
            function a(e) {
    ...
    define(
        'ace/config',
        ['require', 'exports', 'module', 'ace/lib/lang', 'ace/lib/net', 'ace/lib/dom', 'ace/lib/app_config', 'ace/theme/textmate'],
        function (e, t, n) {
            'no use strict';
            var r = e('./lib/lang'),
                i = e('./lib/net'),
            ...
            (t.setLoader = function (e) {
                ...
                (t.loadModule = function (e, n) {
                    ...
                    var u = function (e) {
                        ...
                        var r = function () {
                            a(o, function (e, n) {
                                n && (t.$loaded[o] = n), t._emit('load.module', { name: o, module: n });
                                var r = t.$loading[o];
                                (t.$loading[o] = null),
        ...
        var r = (function () {
            ...
            return (
                (e.prototype.isEqual = function (e) {
                    return (
                        this.start.row === e.start.row && this.end.row === e.end.row && this.start.column === e.start.column && this.end.column === e.end.column
                    );
                }),
    ...
    define(
        ...
        ['require', 'exports', 'module', 'ace/lib/event', 'ace/config', 'ace/lib/useragent', 'ace/lib/dom', 'ace/lib/lang', 'ace/clipboard', 'ace/lib/keys'],
        function (e, t, n) {
            'use strict';
            var r = e('../lib/event'),
                i = e('../config').nls,
                        ...
                        (this.cancelComposition = this.cancelComposition.bind(this)),
                            ...
                            r.addListener(
                                ...
                                function (e) {
                                    ...
                                    t.onFocus(e), s.isEdge ? setTimeout(n.resetSelection.bind(n)) : n.resetSelection();
                                },
                                t
                            ),
                            (this.$focusScroll = !1),
                            t.on('beforeEndOperation', function () {
                                ...
                                n.inComposition && i && ((n.lastValue = n.text.value = ''), n.onCompositionEnd()), n.resetSelection();
                            }),
                            t.on('changeSelection', this.setAriaLabel.bind(this)),
                            (this.resetSelection = v ? this.$resetSelectionIOS : this.$resetSelection),
                            ...
                            (!('oncut' in this.text) || !('oncopy' in this.text) || !('onpaste' in this.text)) &&
                                r.addListener(
                                    e,
                                    'keydown',
                                    function (e) {
                            ...
                            (this.syncComposition = u.delayedCall(this.onCompositionUpdate.bind(this), 50).schedule.bind(null, null)),
                            r.addListener(this.text, 'compositionstart', this.onCompositionStart.bind(this), t),
                            r.addListener(this.text, 'compositionupdate', this.onCompositionUpdate.bind(this), t),
                            r.addListener(this.text, 'keyup', this.onKeyup.bind(this), t),
                            r.addListener(this.text, 'keydown', this.syncComposition.bind(this), t),
                            r.addListener(this.text, 'compositionend', this.onCompositionEnd.bind(this), t),
                            this.closeTimeout,
                            r.addListener(this.text, 'mouseup', this.$onContextMenu.bind(this), t),
                            r.addListener(
                                this.text,
                                'mousedown',
                                function (e) {
                            ...
                            r.addListener(t.renderer.scroller, 'contextmenu', this.$onContextMenu.bind(this), t),
                            r.addListener(this.text, 'contextmenu', this.$onContextMenu.bind(this), t),
                    ...
                    return (
                        (e.prototype.addIosSelectionHandler = function (e, t, n) {
                            ...
                            var o = function (e) {
                                ...
                                if (s || r.inComposition || t.$mouseHandler.isMousePressed) return;
                                if (r.copied) return;
                                ...
                                else if (i < r.lastSelectionStart && r.lastValue[i - 1] == ' ') (u = p.left), (a = d.option);
                                ...
                                else if (o > r.lastSelectionEnd && r.lastValue[o - 1] == ' ') (u = p.right), (a = d.option);
                        ...
                        (e.prototype.onContextMenuClose = function () {
                            ...
                            clearTimeout(this.closeTimeout),
                                (this.closeTimeout = setTimeout(function () {
                                    e.tempStyle && ((e.text.style.cssText = e.tempStyle), (e.tempStyle = '')),
                                        (e.host.renderer.$isMousePressed = !1),
                                        e.host.renderer.$keepTextAreaAtCursor && e.host.renderer.$moveTextAreaToCursor();
                                }, 0));
                        }),
                        ...
                        (e.prototype.onCompositionStart = function (e) {
                            ...
                            (t.end.row = t.start.row),
                                ...
                                this.inComposition.useTextareaForIME
                                    ? ((this.lastValue = this.text.value = ''), (this.lastSelectionStart = 0), (this.lastSelectionEnd = 0))
                                    : (this.text.msGetInputContext && (this.inComposition.context = this.text.msGetInputContext()),
                                      this.text.getInputContext && (this.inComposition.context = this.text.getInputContext()));
                        }),
                                ...
                                this.sendText(e),
                                    this.inComposition.markerRange &&
                                        (this.inComposition.context &&
                                            (this.inComposition.markerRange.start.column = this.inComposition.selectionStart =
                        ...
                        (e.prototype.onCompositionEnd = function (e) {
                            ...
                            (this.inComposition = !1), this.host.onCompositionEnd(), this.host.off('mousedown', this.cancelComposition), e && this.onInput();
                        }),
                        ...
                        (e.prototype.onPaste = function (e) {
                            ...
                            typeof t == 'string'
                                ? (t && this.host.onPaste(t, e), s.isIE && setTimeout(this.resetSelection), r.preventDefault(e))
                        ...
                        (e.prototype.doCopy = function (e, t) {
                            ...
                            this.handleClipboardData(e, i)
                                ...
                                : ((this.copied = !0),
                                  ...
                                  this.text.select(),
                                  setTimeout(function () {
                                      (n.copied = !1), n.resetSelection(), t ? n.host.onCut() : n.host.onCopy();
                                  }));
                        }),
                        ...
                        (e.prototype.onInput = function (e) {
                            ...
                            var t = this.text.value,
                                n = this.sendText(t, !0);
                            (t.length > h + 100 || m.test(n) || (g && this.lastSelectionStart < 1 && this.lastSelectionStart == this.lastSelectionEnd)) &&
                                this.resetSelection();
                        }),
                        (e.prototype.sendText = function (e, t) {
                            this.afterContextMenu && (this.afterContextMenu = !1);
                            if (this.pasted) return this.resetSelection(), e && this.host.onPaste(e), (this.pasted = !1), '';
                            ...
                            return (
                                ...
                                (u && !i && !o && !a && !f) || this.commandMode
                                    ...
                                    : this.host.onTextInput(u, { extendLeft: i, extendRight: o, restoreStart: a, restoreEnd: f }),
                                (this.sendingText = !1),
                                (this.lastValue = e),
                        ...
                        (e.prototype.onSelect = function (e) {
                            ...
                            this.copied
                                ...
                                : g && this.text.selectionStart != this.lastSelectionStart && this.resetSelection();
                        }),
                        (e.prototype.$resetSelectionIOS = function (e) {
                            if (!this.$isFocused || (this.copied && !e) || this.sendingText) return;
                            e || (e = '');
                            var t = '\n ab' + e + 'cde fg\n';
                            t != this.text.value && (this.text.value = this.lastValue = t);
                            var n = 4,
                                r = 4 + (e.length || (this.host.selection.isEmpty() ? 0 : 1));
                            (this.lastSelectionStart != n || this.lastSelectionEnd != r) && this.text.setSelectionRange(n, r),
                                (this.lastSelectionStart = n),
                                (this.lastSelectionEnd = r);
                        }),
                        (e.prototype.$resetSelection = function () {
                            ...
                            var t = 0,
                                ...
                                i = function (t, n) {
                                    var r = n;
                                    for (var i = 1; i <= t - e.rowStart && i < 2 * e.numberOfExtraLines + 1; i++) r += e.host.session.getLine(t - i).length + 1;
                                    return r;
                                };
                            if (this.host.session) {
                                var s = this.host.selection,
                                    o = s.getRange(),
                                    u = s.cursor.row;
                                if (u === this.rowEnd + 1) (this.rowStart = this.rowEnd + 1), (this.rowEnd = this.rowStart + 2 * this.numberOfExtraLines);
                                    ...
                                    (this.rowStart = u > this.numberOfExtraLines ? u - this.numberOfExtraLines : 0),
                                        (this.rowEnd = u > this.numberOfExtraLines ? u + this.numberOfExtraLines : 2 * this.numberOfExtraLines);
                                var a = [];
                                for (var f = this.rowStart; f <= this.rowEnd; f++) a.push(this.host.session.getLine(f));
                            ...
                            this.afterContextMenu && ((this.lastSelectionStart = this.text.selectionStart), (this.lastSelectionEnd = this.text.selectionEnd));
                            if (this.lastSelectionEnd != n || this.lastSelectionStart != t || this.text.selectionEnd != this.lastSelectionEnd)
                                try {
                        ...
                        (e.prototype.setNumberOfExtraLines = function (e) {
                            (this.rowStart = Number.MAX_SAFE_INTEGER), (this.rowEnd = Number.MIN_SAFE_INTEGER);
                            if (e < 0) {
                                this.numberOfExtraLines = 0;
                                return;
                            }
                        ...
                        (e.prototype.setAriaLabel = function () {
                            var e = '';
                            this.host.$textInputAriaLabel && (e += ''.concat(this.host.$textInputAriaLabel, ', '));
                            if (this.host.session) {
                        ...
                        (e.prototype.setAriaOptions = function (e) {
                            e.activeDescendant
                                ? (this.text.setAttribute('aria-haspopup', 'true'),
                                  this.text.setAttribute('aria-autocomplete', e.inline ? 'both' : 'list'),
                                  this.text.setAttribute('aria-activedescendant', e.activeDescendant))
                                ...
                                e.setLabel &&
                                    (this.text.setAttribute('aria-roledescription', i('text-input.aria-roledescription', 'editor')), this.setAriaLabel());
                        }),
                        (e.prototype.focus = function () {
                            var e = this;
                            this.setAriaOptions({ setLabel: this.host.renderer.enableKeyboardAccessibility });
                            if (this.tempStyle || c || this.$focusScroll == 'browser') return this.text.focus({ preventScroll: !0 });
                        ...
                        (e.prototype.onContextMenu = function (e) {
                            (this.afterContextMenu = !0),
                                this.resetSelection(),
                                this.host._emit('nativecontextmenu', { target: this.host, domEvent: e }),
                        ...
                        (e.prototype.moveToMouse = function (e, t) {
                            ...
                            this.tempStyle || (this.tempStyle = this.text.style.cssText),
                                (this.text.style.cssText =
                                    ...
                                    (s.isIE ? 'opacity:0.1;' : '') +
                                    'text-indent: -' +
                                    (this.lastSelectionStart + this.lastSelectionEnd) * this.host.renderer.characterWidth * 0.5 +
                                    'px;');
                            var i = this.host.container.getBoundingClientRect(),
                                ...
                                c = function (e) {
                                    o.translate(n.text, e.clientX - f - 2, Math.min(e.clientY - a - 2, l));
                                };
                            c(e);
                            if (e.type != 'mousedown') return;
                            (this.host.renderer.$isMousePressed = !0),
                                clearTimeout(this.closeTimeout),
                                s.isWin && r.capture(this.host.container, c, this.onContextMenuClose.bind(this));
                        }),
    ...
    define(
        ...
        ['require', 'exports', 'module', 'ace/lib/dom', 'ace/lib/event', 'ace/tooltip', 'ace/config'],
        function (e, t, n) {
            'use strict';
            function c(e) {
                function a() {
            ...
            var h = (function (e) {
                function t(n, r) {
                    ...
                    return (
                        ...
                        r && ((i.onMouseOut = i.onMouseOut.bind(i)), s.addEventListener('mouseout', i.onMouseOut)),
                        i
                    );
                }
                return (
                    ...
                    (t.prototype.showTooltip = function (e) {
                        var n,
                            ...
                            i = r.$annotations[e],
                            o;
                        i ? (o = { displayText: Array.from(i.displayText), type: Array.from(i.type) }) : (o = { displayText: [], type: [] });
                        var u = r.session.getFoldLine(e);
                        if (u && r.$showFoldedAnnotations) {
                            var a = { error: [], security: [], warning: [], info: [], hint: [] },
                        ...
                        var v = { error: [], security: [], warning: [], info: [], hint: [] },
                    ...
                    (t.prototype.$findCellByRow = function (e) {
                        return this.editor.renderer.$gutterLayer.$lines.cells.find(function (t) {
                            return t.row === e;
                        });
                    }),
                    (t.prototype.hideTooltip = function () {
                        ...
                        (this.visibleTooltipRow = undefined), this.editor._signal('hideGutterTooltip', this);
                    }),
        ...
        function f(e) {
            ...
            (this.onDragStart = function (e) {
                ...
                (this.onDragOver = function (e) {
                    if (t.getReadOnly() || !M(e.dataTransfer)) return;
                    return (
                        (p = e.clientX), (d = e.clientY), h || (k(), y++), A !== null && (A = null), (e.dataTransfer.dropEffect = b = _(e)), i.preventDefault(e)
                    );
                }),
                        ...
                        y.replaceChild(
                            s.buildDom(
                                r
                                    ? [
                                          'span',
                                          !n && o('selectall') && ['span', { class: 'ace_mobile-button', action: 'selectall' }, 'Select All'],
                                          n && o('copy') && ['span', { class: 'ace_mobile-button', action: 'copy' }, 'Copy'],
                                          n && o('cut') && ['span', { class: 'ace_mobile-button', action: 'cut' }, 'Cut'],
                                          e && o('paste') && ['span', { class: 'ace_mobile-button', action: 'paste' }, 'Paste'],
                                          i && o('undo') && ['span', { class: 'ace_mobile-button', action: 'undo' }, 'Undo'],
                                          o('find') && ['span', { class: 'ace_mobile-button', action: 'find' }, 'Find'],
                                          o('openCommandPalette') && ['span', { class: 'ace_mobile-button', action: 'openCommandPalette' }, 'Palette']
                                      ]
                                    : ['span']
                            ),
                            y.firstChild
                    ...
                    this.add('braces', 'insertion', function (t, n, r, i, s) {
                        ...
                        if (s == '{') {
                            ...
                            if (d.isSaneInsertion(r, i))
                                return /[\]\}\)]/.test(a[u.column]) || r.inMultiSelectMode || e.braces
                            ...
                            if (g == '}') {
                                ...
                                if (y !== null && d.isAutoInsertedClosing(u, a, s)) return d.popAutoInsertedClosing(), { text: '', selection: [1, 1] };
                            }
                        } else {
                            if (s == '\n' || s == '\r\n') {
                                h(r);
                    ...
                    e.closeDocComment !== !1 &&
                        this.add('doc comment end', 'insertion', function (e, t, n, r, i) {
                            if (e === 'doc-start' && (i === '\n' || i === '\r\n') && n.selection.isEmpty()) {
                                ...
                                if (/\s*\*/.test(u))
                                    return /^\s*\*/.test(o)
                                        ? { text: i + m + '* ', selection: [1, 2 + m.length, 1, 2 + m.length] }
                                        : { text: i + m + ' * ', selection: [1, 3 + m.length, 1, 3 + m.length] };
    ...
    define('ace/unicode', ['require', 'exports', 'module'], function (e, t, n) {
        'use strict';
        var r = [
                48, 9, 8, 25, 5, 0, 2, 25, 48, 0, 11, 0, 5, 0, 6, 22, 2, 30, 2, 457, 5, 11, 15, 4, 8, 0, 2, 0, 18, 116, 2, 1, 3, 3, 9, 0, 2, 2, 2, 0, 2, 19, 2,
                82, 2, 138, 2, 4, 3, 155, 12, 37, 3, 0, 8, 38, 10, 44, 2, 0, 2, 1, 2, 1, 2, 0, 9, 26, 6, 2, 30, 10, 7, 61, 2, 9, 5, 101, 2, 7, 3, 9, 2, 18, 3,
                0, 17, 58, 3, 100, 15, 53, 5, 0, 6, 45, 211, 57, 3, 18, 2, 5, 3, 11, 3, 9, 2, 1, 7, 6, 2, 2, 2, 7, 3, 1, 3, 21, 2, 6, 2, 0, 4, 3, 3, 8, 3, 1, 3,
                3, 9, 0, 5, 1, 2, 4, 3, 11, 16, 2, 2, 5, 5, 1, 3, 21, 2, 6, 2, 1, 2, 1, 2, 1, 3, 0, 2, 4, 5, 1, 3, 2, 4, 0, 8, 3, 2, 0, 8, 15, 12, 2, 2, 8, 2,
                2, 2, 21, 2, 6, 2, 1, 2, 4, 3, 9, 2, 2, 2, 2, 3, 0, 16, 3, 3, 9, 18, 2, 2, 7, 3, 1, 3, 21, 2, 6, 2, 1, 2, 4, 3, 8, 3, 1, 3, 2, 9, 1, 5, 1, 2, 4,
                3, 9, 2, 0, 17, 1, 2, 5, 4, 2, 2, 3, 4, 1, 2, 0, 2, 1, 4, 1, 4, 2, 4, 11, 5, 4, 4, 2, 2, 3, 3, 0, 7, 0, 15, 9, 18, 2, 2, 7, 2, 2, 2, 22, 2, 9,
                2, 4, 4, 7, 2, 2, 2, 3, 8, 1, 2, 1, 7, 3, 3, 9, 19, 1, 2, 7, 2, 2, 2, 22, 2, 9, 2, 4, 3, 8, 2, 2, 2, 3, 8, 1, 8, 0, 2, 3, 3, 9, 19, 1, 2, 7, 2,
                2, 2, 22, 2, 15, 4, 7, 2, 2, 2, 3, 10, 0, 9, 3, 3, 9, 11, 5, 3, 1, 2, 17, 4, 23, 2, 8, 2, 0, 3, 6, 4, 0, 5, 5, 2, 0, 2, 7, 19, 1, 14, 57, 6, 14,
                2, 9, 40, 1, 2, 0, 3, 1, 2, 0, 3, 0, 7, 3, 2, 6, 2, 2, 2, 0, 2, 0, 3, 1, 2, 12, 2, 2, 3, 4, 2, 0, 2, 5, 3, 9, 3, 1, 35, 0, 24, 1, 7, 9, 12, 0,
                2, 0, 2, 0, 5, 9, 2, 35, 5, 19, 2, 5, 5, 7, 2, 35, 10, 0, 58, 73, 7, 77, 3, 37, 11, 42, 2, 0, 4, 328, 2, 3, 3, 6, 2, 0, 2, 3, 3, 40, 2, 3, 3,
                32, 2, 3, 3, 6, 2, 0, 2, 3, 3, 14, 2, 56, 2, 3, 3, 66, 5, 0, 33, 15, 17, 84, 13, 619, 3, 16, 2, 25, 6, 74, 22, 12, 2, 6, 12, 20, 12, 19, 13, 12,
                2, 2, 2, 1, 13, 51, 3, 29, 4, 0, 5, 1, 3, 9, 34, 2, 3, 9, 7, 87, 9, 42, 6, 69, 11, 28, 4, 11, 5, 11, 11, 39, 3, 4, 12, 43, 5, 25, 7, 10, 38, 27,
                5, 62, 2, 28, 3, 10, 7, 9, 14, 0, 89, 75, 5, 9, 18, 8, 13, 42, 4, 11, 71, 55, 9, 9, 4, 48, 83, 2, 2, 30, 14, 230, 23, 280, 3, 5, 3, 37, 3, 5, 3,
                7, 2, 0, 2, 0, 2, 0, 2, 30, 3, 52, 2, 6, 2, 0, 4, 2, 2, 6, 4, 3, 3, 5, 5, 12, 6, 2, 2, 6, 67, 1, 20, 0, 29, 0, 14, 0, 17, 4, 60, 12, 5, 0, 4,
                11, 18, 0, 5, 0, 3, 9, 2, 0, 4, 4, 7, 0, 2, 0, 2, 0, 2, 3, 2, 10, 3, 3, 6, 4, 5, 0, 53, 1, 2684, 46, 2, 46, 2, 132, 7, 6, 15, 37, 11, 53, 10, 0,
                17, 22, 10, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 31, 48, 0, 470, 1, 36, 5, 2, 4, 6, 1, 5, 85, 3, 1, 3, 2, 2, 89, 2, 3, 6, 40, 4, 93,
                18, 23, 57, 15, 513, 6581, 75, 20939, 53, 1164, 68, 45, 3, 268, 4, 27, 21, 31, 3, 13, 13, 1, 2, 24, 9, 69, 11, 1, 38, 8, 3, 102, 3, 1, 111, 44,
                25, 51, 13, 68, 12, 9, 7, 23, 4, 0, 5, 45, 3, 35, 13, 28, 4, 64, 15, 10, 39, 54, 10, 13, 3, 9, 7, 22, 4, 1, 5, 66, 25, 2, 227, 42, 2, 1, 3, 9,
                7, 11171, 13, 22, 5, 48, 8453, 301, 3, 61, 3, 105, 39, 6, 13, 4, 6, 11, 2, 12, 2, 4, 2, 0, 2, 1, 2, 1, 2, 107, 34, 362, 19, 63, 3, 53, 41, 11,
                5, 15, 17, 6, 13, 1, 25, 2, 33, 4, 2, 134, 20, 9, 8, 25, 5, 0, 2, 25, 12, 88, 4, 5, 3, 5, 3, 5, 3, 2
            ],
            i = 0,
            s = [];
    ...
    define(
        ...
        ['require', 'exports', 'module', 'ace/range', 'ace/edit_session/fold_line', 'ace/edit_session/fold', 'ace/token_iterator', 'ace/mouse/mouse_event'],
        function (e, t, n) {
            'use strict';
            function a() {
            ...
            (this.findMatchingBracket = function (e, t) {
                ...
                (this.getMatchingBracketRanges = function (e, t) {
                    var n = this.getLine(e.row),
                        ...
                        o = s && s.match(r);
                    o || ((s = (t === undefined || t) && n.charAt(e.column)), (e = { row: e.row, column: e.column + 1 }), (o = s && s.match(r)));
                    if (!o) return null;
                                ...
                                (u = this.getFoldLine(a, u)),
                                    u
                                        ? ((o = []),
                                          ...
                                          (a = u.end.row + 1))
                                        : ((o = this.$getDisplayTokens(n[a])), (i[a] = this.$computeWrapSplits(o, s, r)), a++);
                        }),
            ...
            o = (function () {
                ...
                return (
                    ...
                    (e.prototype.parseReplaceString = function (e) {
                        var t = { DollarSign: 36, Ampersand: 38, Digit0: 48, Digit1: 49, Digit9: 57, Backslash: 92, n: 110, t: 116 },
                            n = '';
            ...
            u = (function () {
                ...
                return (
                    ...
                    (e.prototype.handleKeyboard = function (e, t, n, r) {
                        ...
                        if (s) if (s == 'chainKeys' || s[s.length - 1] == 'chainKeys') return (e.$keyChain = e.$keyChain || i), { command: 'null' };
                        if (e.$keyChain)
                            if ((!!t && t != 4) || n.length != 1) {
                ...
                u = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.canExecute = function (e, t) {
                            return (
                                typeof e == 'string' && (e = this.commands[e]),
                                e ? (t && t.$readOnly && !e.readOnly ? !1 : this.$checkCommandState != 0 && e.isAvailable && !e.isAvailable(t) ? !1 : !0) : !1
                            );
                        }),
    ...
    define('ace/commands/default_commands', ['require', 'exports', 'module', 'ace/lib/lang', 'ace/config', 'ace/range'], function (e, t, n) {
        ...
        t.commands = [
            ...
            { name: 'passKeysToBrowser', description: 'Pass keys to browser', bindKey: o(null, null), exec: function () {}, passEvent: !0, readOnly: !0 },
                ...
                C = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.setValue = function (e, t) {
                            return (
                                this.session.doc.setValue(e), t ? (t == 1 ? this.navigateFileEnd() : t == -1 && this.navigateFileStart()) : this.selectAll(), e
                            );
                        }),
                        (e.prototype.getValue = function () {
                        ...
                        set: function (e) {
                            ...
                            this.$resetCursorStyle(),
                                this.$readOnlyCallback ||
                                    (this.$readOnlyCallback = function (e) {
                                        var n = !1;
                                        if (e && e.type == 'keydown') {
                                            e && e.key && !e.ctrlKey && !e.metaKey && (e.key == ' ' && e.preventDefault(), (n = e.key.length == 1));
                                            if (!n) return;
                            ...
                            e
                                ...
                                : (T.removeListener(n, 'keydown', this.$readOnlyCallback),
                                  ...
                                  this.hoverTooltip && (this.hoverTooltip.destroy(), (this.hoverTooltip = null)));
                        },
                        initialValue: !1
                    },
                        ...
                        set: function (e) {
                            ...
                            e
                                ? ((this.renderer.enableKeyboardAccessibility = !0),
                                  ...
                                  this.renderer.scroller.setAttribute('aria-roledescription', E('editor.scroller.aria-roledescription', 'editor')),
                                  this.renderer.scroller.classList.add(this.renderer.keyboardFocusClassName),
                                  this.renderer.scroller.setAttribute(
                                      'aria-label',
                                      E('editor.scroller.aria-label', 'Editor content, press Enter to start editing, press Escape to exit')
                                  ),
                                  ...
                                  this.renderer.$gutter.setAttribute('aria-roledescription', E('editor.gutter.aria-roledescription', 'editor gutter')),
    ...
    define(
        'ace/layer/gutter',
        ['require', 'exports', 'module', 'ace/lib/dom', 'ace/lib/oop', 'ace/lib/lang', 'ace/lib/event_emitter', 'ace/layer/lines', 'ace/config'],
        function (e, t, n) {
            'use strict';
            function l(e) {
                    ...
                    return (
                        ...
                        (e.prototype.setAnnotations = function (e) {
                            ...
                            for (var t = 0; t < e.length; t++) {
                                ...
                                f
                                    ...
                                    : a === 'warning' && !/\bace_(error|security)\b/.test(i.className)
                                    ? (i.className = ' ace_warning')
                                    : a === 'info' && !i.className
                                    ? (i.className = ' ace_info')
                                    : a === 'hint' && !i.className && (i.className = ' ace_hint');
                            }
                        }),
                        ...
                        (e.prototype.$renderCell = function (e, t, n, i) {
                            ...
                            this.$highlightGutterLine &&
                                (i == this.$cursorRow || (n && i < this.$cursorRow && i >= y && this.$cursorRow <= n.end.row)) &&
                            ...
                            if (x) {
                                ...
                                A
                                    ? f.setAttribute(
                                          'aria-label',
                                          a('gutter.code-folding.range.aria-label', 'Toggle code folding, rows $0 through $1', [A.start.row + 1, A.end.row + 1])
                                      )
                                    : n
                                    ? f.setAttribute(
                                          'aria-label',
                                          a('gutter.code-folding.closed.aria-label', 'Toggle code folding, rows $0 through $1', [
                                              n.start.row + 1,
                                              n.end.row + 1
                                          ])
                                      )
                                    : f.setAttribute('aria-label', a('gutter.code-folding.open.aria-label', 'Toggle code folding, row $0', [i + 1])),
                                    N
                                        ? (f.setAttribute('aria-expanded', 'false'),
                                          f.setAttribute('title', a('gutter.code-folding.closed.title', 'Unfold code')))
                                        : (f.setAttribute('aria-expanded', 'true'), f.setAttribute('title', a('gutter.code-folding.open.title', 'Fold code')));
                            } else
                                f &&
                            ...
                            if (k && this.$showFoldedAnnotations) {
                                ...
                                (l.className = 'ace_gutter_annotation'),
                                    ...
                                    this.$useSvgGutterIcons
                                        ...
                                        : s.classList.add(this.$annotations[i].className.replace(' ', '')),
                                    r.setStyle(h.style, 'height', b),
                                    r.setStyle(l.style, 'display', 'block'),
                                    r.setStyle(l.style, 'height', b);
                                var M;
                        ...
                        (e.prototype.$addCustomWidget = function (e, t, n) {
                            var i = t.className,
                                ...
                                o = t.title,
                                u = t.callbacks;
                            (this.session.$gutterCustomWidgets[e] = { className: i, label: s, title: o, callbacks: u }), this.$hideFoldWidget(e, n);
            ...
            s = (function () {
                ...
                return (
                        ...
                        for (; l <= f; l++)
                            (d.start.row = d.end.row = l),
                                ...
                                this.drawSingleLineMarker(
                                    e,
                                    d,
                                    n + (l == a ? ' ace_start' : '') + ' ace_br' + o(l == a || (l == a + 1 && t.start.column), c < h, h > p, l == f),
                                    i,
                                    l == f ? 0 : 1,
                                    s
                                );
                    ...
                    (e.prototype.drawMultiLineMarker = function (e, t, n, r, i) {
                        ...
                        this.elt(
                            n + (c ? ' ace_br' + c : ''),
                            'height:' + o + 'px;' + 'right:' + s + 'px;' + 'top:' + u + 'px;' + 'left:' + s + 'px;' + (i || '')
                        );
                    }),
                ...
                l = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.$renderToken = function (e, t, n, r) {
                            ...
                            while ((l = o.exec(r))) {
                                ...
                                if (h) {
                                    ...
                                    var w = this.dom.createElement('span');
                                    (w.className = 'ace_invisible ace_invisible_space ace_invalid'),
                                    ...
                                    (w.style.width = i.config.characterWidth * 2 + 'px'),
                                        (w.className = i.showSpaces ? 'ace_cjk ace_invisible ace_invisible_space' : 'ace_cjk'),
                                        (w.textContent = i.showSpaces ? i.SPACE_CHAR : v),
                                        u.appendChild(w);
                                } else if (m) {
                                    t += 1;
                                    var w = this.dom.createElement('span');
                                    (w.style.width = i.config.characterWidth * 2 + 'px'), (w.className = 'ace_cjk'), (w.textContent = m), u.appendChild(w);
                                }
                            }
                            ...
                            if (!f(n.type)) {
                                ...
                                n.type == 'fold' &&
                                    ((w.style.width = n.value.length * this.config.characterWidth + 'px'),
                                    w.setAttribute('title', a('inline-fold.closed.title', 'Unfold code'))),
                                    (w.className = E),
                                    w.appendChild(u),
                                    e.appendChild(w);
                        ...
                        (e.prototype.$highlightIndentGuide = function () {
                            ...
                            this.$highlightIndentGuideMarker = { indentLevel: undefined, start: undefined, end: undefined, dir: undefined };
                                ...
                                if (r + c.length < o) (u = this.$renderToken(a, u, l, c)), (r += c.length);
                                    ...
                                    while (r + c.length >= o) {
                                        (u = this.$renderToken(a, u, l, c.substring(0, o - r))),
                                            ...
                                            (a = this.$createLineElement()),
                                            e.appendChild(a);
                                        var h = this.dom.createTextNode(s.stringRepeat('\u00a0', n.indent), this.element);
                                        (h.charCount = 0), a.appendChild(h), i++, (u = 0), (o = n[i] || Number.MAX_VALUE);
                                    }
                ...
                return (
                    ...
                    (e.prototype.setSmoothBlinking = function (e) {
                        e != this.smoothBlinking &&
                            ((this.smoothBlinking = e), r.setCssClass(this.element, 'ace_smooth-blinking', e), this.$updateCursors(!0), this.restartTimer());
                    }),
            ...
            var f = (function (e) {
                ...
                return (
                    ...
                    (t.prototype.onMouseDown = function (e, t) {
                        ...
                        return this._emit('scroll', { data: this.scrollTopFromThumbTop(c) }), o.preventDefault(t);
                    }),
                    (t.prototype.getHeight = function () {
                        return this.height;
                    }),
            ...
            var l = (function (e) {
                ...
                return (
                    ...
                    (t.prototype.onMouseDown = function (e, t) {
                        ...
                        return this._emit('scroll', { data: this.scrollLeftFromThumbLeft(c) }), o.preventDefault(t);
                    }),
                    (t.prototype.getHeight = function () {
                        return this.isVisible ? this.height : 0;
                    }),
    ...
    define(
        ...
        ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/dom', 'ace/lib/lang', 'ace/lib/event', 'ace/lib/useragent', 'ace/lib/event_emitter'],
        function (e, t, n) {
            var r = e('../lib/oop'),
                i = e('../lib/dom'),
                s = e('../lib/lang'),
            ...
            (h.prototype.$characterSize = { width: 0, height: 0 }), r.implement(h.prototype, a), (t.FontMetrics = h);
        }
    ),
            ...
            o = (function () {
                function e(e, t) {
                    (this.renderer = t),
                        ...
                        (this.colors = {}),
                        (this.colors.dark = { error: 'rgba(255, 18, 18, 1)', warning: 'rgba(18, 136, 18, 1)', info: 'rgba(18, 18, 136, 1)' }),
                ...
                return (
                    ...
                    (e.prototype.setScrollBarV = function (e) {
                        this.$createCanvas(), (this.scrollbarV = e), e.element.appendChild(this.canvas), this.setDimensions();
                    }),
                        ...
                        if (i) {
                            ...
                            for (var o = 0; o < i.length; o++) {
                                var u = i[o].row,
                                    ...
                                    h = Math.round((l + c) / 2),
                                    p = c - h;
                                p < this.halfMinDecorationHeight && (p = this.halfMinDecorationHeight),
                                    h - p < 0 && (h = p),
                    ...
                    (e.prototype.getVerticalOffsetForRow = function (e) {
                        e |= 0;
                        var t = this.renderer.session.documentToScreenRow(e, 0) * this.lineHeight;
                        return t;
                    }),
                    (e.prototype.setDimensions = function (e) {
                        (e = e || this.renderer.layerConfig),
                            ...
                            this.maxHeight < this.canvasHeight ? (this.heightRatio = 1) : (this.heightRatio = this.canvasHeight / this.maxHeight);
                    }),
                ...
                return (
                    ...
                    (e.prototype.onResize = function (e, t, n, r) {
                        ...
                        r || (r = i.clientHeight || i.scrollHeight),
                            !r &&
                                ...
                                ((i.style.height = '1px'), (r = i.clientHeight || i.scrollHeight)),
                    ...
                    (e.prototype.$renderChanges = function (e, t) {
                        ...
                        e & this.CHANGE_TEXT
                            ...
                            ? (this.$showGutter && this.$gutterLayer.update(n), this.$customScrollbar && this.$scrollDecorator.$updateDecorators(n))
                    ...
                    (e.prototype.$computeLayerConfig = function () {
                        ...
                        E && (m = E.start.row),
                            ...
                            d < 0 && y > 0 && ((y = Math.max(0, y + Math.floor(d / w))), (d = this.scrollTop - y * w));
                        var S = 0;
                    ...
                    (e.prototype.setGhostText = function (e, t) {
                        ...
                        this.addToken(s[0].text, 'ghost_text', r.row, r.column), (this.$ghostText = { text: e, position: { row: r.row, column: r.column } });
                        ...
                        if (s.length > 1) {
                            ...
                            s.slice(1).forEach(function (e) {
                                ...
                                (this.$ghostTextWidget = { el: o, row: r.row, column: r.column, className: 'ace_ghost_text_container' }),
                            ...
                            e === !0
                                ? ((this.scrollBarV = new d(this.container, this)),
                                  ...
                                  this.$scrollDecorator
                                      ? (this.$scrollDecorator.setScrollBarV(this.scrollBarV), this.$scrollDecorator.$updateDecorators())
                                      : ((this.$scrollDecorator = new b(this.scrollBarV, this)), this.$scrollDecorator.$updateDecorators()))
                    ...
                    useResizeObserver: {
                        set: function (e) {
                            !e && this.$resizeObserver
                                ? (this.$resizeObserver.disconnect(), this.$resizeTimer.cancel(), (this.$resizeTimer = this.$resizeObserver = null))
    ...
    define('ace/ext/error_marker', ['require', 'exports', 'module', 'ace/lib/dom', 'ace/range', 'ace/config'], function (e, t, n) {
        ...
        (t.showErrorMarker = function (e, t) {
            ...
            var h = { row: i.row, fixedWidth: !0, coverGutter: !0, el: r.createElement('div'), type: 'errorMarker' },
