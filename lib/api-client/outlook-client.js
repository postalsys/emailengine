...
class OutlookClient extends BaseClient {
    ...
    async getMessage(messageId, options) {
        ...
        if (!messageData.internetMessageHeaders) {
            let messageHeadersData;
            try {
                messageHeadersData = await this.request(`${OUTLOOK_API_BASE}/me/messages/${messageId}`, 'get', {
            ...
            messageData.internetMessageHeaders = messageHeadersData?.internetMessageHeaders || [];
        }
