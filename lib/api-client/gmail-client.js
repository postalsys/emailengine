...
const { MESSAGE_UPDATED_NOTIFY, MESSAGE_DELETED_NOTIFY, EMAIL_SENT_NOTIFY, REDIS_PREFIX } = require('../consts');
...
class GmailClient extends BaseClient {
    ...
    async processHistoryEntry(historyEntry) {
        console.log('HISTORY ENTRY', JSON.stringify(historyEntry, false, 2));
        ...
        for (let entry of historyEntry?.messagesAdded || []) {
            ...
            // TODO: generate a new email webhook
        }
    }
