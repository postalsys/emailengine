...
class SubScript {
    ...
    async exec(payload, options) {
        ...
        // Allow callers (and tests) to override the execution timeout; defaults
        // to SUBSCRIPT_RUNTIME_TIMEOUT to preserve existing behavior.
        let runtimeTimeout = (options && options.timeout) || SUBSCRIPT_RUNTIME_TIMEOUT;
