...
const FETCH_RETRY_INTERVAL = 1000;
const FETCH_RETRY_EXPONENTIAL = 2;
const FETCH_RETRY_MAX = 60 * 1000;

const calculateFetchBackoff = attempt => Math.min(FETCH_RETRY_MAX, FETCH_RETRY_INTERVAL * FETCH_RETRY_EXPONENTIAL ** attempt);
