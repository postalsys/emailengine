...
const inlineMessage = require('./inline-message');
...
class Connection {
    ...
    async listMailboxes() {
        ...
        return await this.getCurrentListing();
    }
    ...
    async queueMessageEntry(data, meta) {
        ...
        if (data.reference && data.reference.message) {
            ...
            try {
                ...
                referencedMessage = await this.getMessage(data.reference.message, {
                    fields: !data.reference.inline
                        ...
                        : false,
                    header: data.reference.inline ? true : false,
                    textType: data.reference.inline ? '*' : false
                });
            ...
            if (referencedMessage) {
                ...
                if (data.html) {
                    data.html = inlineMessage(data.reference.action, 'html', data.html, referencedMessage);
                }

                if (data.text) {
                    data.text = inlineMessage(data.reference.action, 'plain', data.text, referencedMessage);
                }
