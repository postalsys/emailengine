...
const TRY_IMPACT = {
    destructive: { warn: true, text: 'This permanently removes data from this instance. It cannot be undone from here.' },
    sends: { warn: true, text: 'This sends real email. Messages reach the recipients in the request, not a sandbox.' },
    readonly: null,
