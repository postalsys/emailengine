        ...
        options: {
            ...
            plugins: {
                'hapi-swagger': {
                    ...
                    responses: streamResponses('Successful. The raw RFC822 message source.', 400, 401, 403, 404, 429, 500, 503)
                }
            },
                    ...
                    webSafeHtml: Joi.boolean()
                        ...
                        .description(
                            'Shorthand option to fetch and preprocess HTML and inline images. Overrides `textType`, `preProcessHtml`, and `embedAttachedImages` options. ' +
                                `Quoted thread history is folded into a single collapsed <details class="${COLLAPSE_CLASS}"> element.`
                        )
                        .label('WebSafeHtml'),
        ...
        options: {
            ...
            plugins: {
                'hapi-swagger': {
                    ...
                    responses: streamResponses('Successful. The attachment content as a binary stream.', 400, 401, 403, 404, 429, 500, 503)
                }
            },
