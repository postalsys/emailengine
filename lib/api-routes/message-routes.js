        ...
        options: {
            ...
            plugins: {
                mcp: {
                    ...
                    title: 'Get message',
                    description:
                        'Get one message: subject, addresses, date, flags, attachment list and the text id used by get_message_text. Set textType to also include the message text directly.'
                },
                openapi: {
        ...
        options: {
            ...
            plugins: {
                mcp: {
                    ...
                    description: 'Fetch the text content of a message. The text id comes from the text.id field of get_message or list_messages.'
                },
                openapi: {
