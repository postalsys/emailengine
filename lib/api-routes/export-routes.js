...
const { accountIdSchema, exportRequestSchema, exportStatusSchema, exportListSchema, exportIdSchema, apiResponses } = require('../schemas');
...
async function init(args) {
    ...
    server.route({
        ...
        options: {
            ...
            notes: ['Creates a new bulk message export job. The export runs asynchronously and notifies via webhook when complete.', BEHAVIOR.BACKGROUND_JOB],
            tags: ['api', 'Export (Beta)'],

            plugins: {
                openapi: {
                    'x-ee-behavior': [BEHAVIOR.BACKGROUND_JOB],
                    responses: apiResponses('Returns the ID of the started export. Poll the status endpoint until it completes.', 400, 401, 403, 404, 429, 500)
                }
            },
    ...
    server.route({
        ...
        options: {
            ...
            plugins: {
                openapi: {
                    responses: apiResponses('Returns the export progress, and the download size once it has completed.', 400, 401, 403, 404, 429, 500)
                }
            },
        ...
        options: {
            ...
            plugins: {
                openapi: {
                    ...
                    responses: apiResponses('Returns the export archive as gzip-compressed NDJSON.', 400, 401, 403, 404, 429, 500, 503)
                }
            },
    ...
    server.route({
        ...
        options: {
            ...
            plugins: {
                openapi: {
                    responses: apiResponses('Returns a deletion marker. Any partially written export file is removed.', 400, 401, 403, 404, 429, 500)
                }
            },
    ...
    server.route({
        ...
        options: {
            ...
            plugins: {
                openapi: {
                    responses: apiResponses('Returns the exports for the account with their progress.', 400, 401, 403, 429, 500)
                }
            },
