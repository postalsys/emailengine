...
const { accountIdSchema, exportRequestSchema, exportStatusSchema, exportListSchema, exportIdSchema, errorResponses, streamResponses } = require('../schemas');
        ...
        options: {
            ...
            plugins: {
                'hapi-swagger': {
                    ...
                    responses: streamResponses('Successful. The export archive as gzip-compressed NDJSON.', 400, 401, 403, 404, 429, 500, 503)
                }
            },
