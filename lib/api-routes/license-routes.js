...
const { licenseSchema, apiResponses } = require('../schemas');
        ...
        options: {
            ...
            plugins: {
                mcp: {
                    name: 'get_license',
                    title: 'Get license',
                    description: 'Get the active license: who it is issued to and when it expires, or an empty object when the instance runs unlicensed.'
                },
                openapi: {
                    responses: apiResponses('Returns the active license and its expiry, or an empty object when unlicensed.', 401, 403, 429, 500)
                }
            },
        ...
        options: {
            ...
            plugins: {
                openapi: {
                    ...
                    responses: apiResponses('Returns an empty license object. EmailEngine drops to limited mode.', 401, 403, 429, 500)
                }
            },
        ...
        options: {
            ...
            plugins: {
                mcp: {
                    name: 'set_license',
                    title: 'Apply license',
                    description: 'Apply a license key to this instance. Takes the full license text as issued, including its BEGIN and END lines.'
                },
                openapi: {
                    responses: apiResponses('Returns the registered license.', 400, 401, 403, 429, 500)
                }
            },
