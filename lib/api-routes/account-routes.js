            ...
            validate: {
                ...
                query: Joi.object({
                    revoke: Joi.boolean()
                        ...
                        .default(false)
                        .description(
                            'If true, EmailEngine attempts to revoke the upstream OAuth2 grant at the provider before deleting the account. Currently supported for OAuth2 providers that implement revocation (Gmail). For other providers and non-OAuth2 accounts the flag is a no-op. Revoke failures are logged and do not block deletion.'
                        )
                })
            },
