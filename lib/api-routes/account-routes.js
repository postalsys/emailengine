    ...
    server.route({
        ...
        options: {
            ...
            notes: [
                ...
                'Set `skipServerSettings` to complete an IMAP setup without asking the user for mail server settings whenever EmailEngine can discover and verify them from the address and password alone.',
            ...
            validate: {
                ...
                payload: Joi.object({
                    ...
                    skipServerSettings: Joi.boolean()
                        ...
                        .default(false)
                        .description(
                            'If true, the mail server settings step is skipped whenever the IMAP and SMTP settings for the address can both be discovered and verified with the password the user enters. The step is still shown if discovery or verification does not fully succeed. Applies to the IMAP setup path only.'
                        ),
