        ...
        options: {
            ...
            plugins: {
                mcp: {
                    ...
                    title: 'Send message',
                    description:
                        'Send an email from the account to real recipients - confirm with the user before calling this. Takes structured fields (to, subject, text, html). Set reference to reply to or forward a stored message. Delivery is queued; the response carries the queue id for get_outbox.',
