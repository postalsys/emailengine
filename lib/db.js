...
const notifyQueue = new Queue('notify', {
    redis: Object.assign({ connectionName: `${REDIS_CONF.connectionName}[notify]` }, REDIS_CONF),
    prefix: `${REDIS_PREFIX}bull`
});

const submitQueue = new Queue('submit', {
    redis: Object.assign({ connectionName: `${REDIS_CONF.connectionName}[submit]` }, REDIS_CONF),
    prefix: `${REDIS_PREFIX}bull`
});
