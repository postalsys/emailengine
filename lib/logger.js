...
// How long the process stays alive after a fatal error before the exit lands. It covers the
// error-tracking delivery, and it is also what gives Node room to emit 'rejectionHandled' for a
// handler that arrived a microtask too late (see the listener at the bottom of this file).
