...
// Settings a narrowed access token may not write, whatever its record grants. `write/settings` is
...
const PRIVILEGED_SETTINGS_KEYS = [
    ...
    // Listener passwords, the PROXY-protocol trust flags of the listeners, and the AI key
    'smtpServerPassword',
    'imapProxyServerPassword',
    'smtpServerProxy',
...
module.exports = {
    ...
    // What a narrowed token may never write, see PRIVILEGED_SETTINGS_KEYS above
