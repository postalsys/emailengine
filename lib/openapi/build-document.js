...
// Where a route keeps the documentation metadata that its joi schemas cannot express
...
function pluginOptions(route) {
    return (route.settings.plugins && route.settings.plugins[PLUGIN_OPTIONS_KEY]) || {};
}
