 ...
 *        binding for the token), scopes (the MCP scopes the operator approved), permissions,
 *        description (for the admin tokens listing)
...
async function createAuthorizationCode(opts) {
    ...
    if (!scopes.length) {
        ...
        // and a caller that forgot the argument fails here rather than minting a mail credential
