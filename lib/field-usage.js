...
const FIELD_USAGE = {
    ...
    webSafeHtml:
        ...
        `Quoted thread history is folded into one collapsed \`<details class="${COLLAPSE_CLASS}">\` element so you can hide it behind a single control. Its \`<summary>\` is deliberately empty, so supply your own label.`,
