...
//
// The remaining options (jsonPath, cache, cors, info) stay in workers/api.js, where the
// values they depend on live. The swagger-ui presentation options are gone entirely - that
// UI is retired in favour of the server-rendered reference.
