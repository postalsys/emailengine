    ...
    server.route({
        ...
        async handler(request, h) {
            const values = {
                ...
                disableTokens: (await settings.get('disableTokens')) || false
            };
        ...
        async handler(request, h) {
            try {
                let data = {
                    ...
                    disableTokens: request.payload.disableTokens
                };
        ...
        options: {
            validate: {
                ...
                payload: Joi.object({
                    ...
                    disableTokens: Joi.boolean().truthy('Y', 'true', '1', 'on').falsy('N', 'false', 0, '').default(false)
                })
            }
        }
    });
    ...
    server.route({
        ...
        async handler(request) {
            try {
                ...
                let res = await fetch(`${LICENSE_HOST}/licenses/trial`, {
                    method: 'post',
                    body: JSON.stringify({
