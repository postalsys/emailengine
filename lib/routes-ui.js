                                ...
                                */
                                ...
                                case 'heapUsed':
                                    if (!threadInfo.isUnresponsive) {
                                        ...
                                        // Calculate relative usage if heapTotal is available
                                        if (threadInfo.heapTotal) {
                                            threadInfo.heapRelative = percentFormatter.format(threadInfo.heapUsed / threadInfo.heapTotal);
                                        }
                                    }
                                    break;
