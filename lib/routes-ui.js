...
const { oauth2Apps, LEGACY_KEYS, OAUTH_PROVIDERS, oauth2ProviderData, SERVICE_ACCOUNT_PROVIDERS } = require('./oauth2-apps');
...
const oauthUpdateSchema = {
    ...
    authority: Joi.string()
        ...
        .when('provider', {
            is: 'outlookService',
            then: Joi.string().invalid('common', 'organizations', 'consumers')
        })
        .example(false)
