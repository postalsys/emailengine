    ...
    server.route({
        ...
        async handler(request, h) {
            const values = {
                ...
                extractReplyText: (await settings.get('extractReplyText')) || false,
        ...
        async handler(request, h) {
            try {
                let data = {
                    ...
                    extractReplyText: request.payload.extractReplyText
                };
        ...
        options: {
            validate: {
                ...
                payload: Joi.object({
                    ...
                    extractReplyText: settingsSchema.extractReplyText.default(false),
