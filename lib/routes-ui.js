...
const { locales, joiLocales } = require('./translations');
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(joiLocales, Joi.object(configWebhooksSchema))
            }
        }
    });
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(joiLocales, Joi.object(configLoggingSchema))
            }
        }
    });
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(joiLocales, Joi.object(oauthCreateSchema).tailor('web'))
            }
        }
    });
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(joiLocales, Joi.object(oauthUpdateSchema))
            }
        }
    });
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(
                    joiLocales,
                    Joi.object({ token: Joi.string().length(64).hex().required().example('123456').description('Access token') })
                )
            }
        }
    });
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(joiLocales, Joi.object({}))
            }
        }
    });
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(joiLocales, Joi.object(configDocumentStoreSchema))
            }
        }
    });
    ...
    server.route({
        ...
        async handler(request, h) {
            ...
            return h.view(
                'config/imap-proxy',
                {
                    pageTitle: 'IMAP Proxy Interface',
                    menuConfig: true,
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(joiLocales, Joi.object(configImapProxySchema))
            }
        }
    });
    ...
    server.route({
        ...
        options: {
            validate: {
                ...
                payload: validationHelper(joiLocales, Joi.object(configSmtpSchema))
            }
        }
    });
