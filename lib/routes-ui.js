...
function applyRoutes(server, call) {
    ...
    server.route({
        ...
        async handler(request, h) {
            ...
            /*
                {
                email: 'andris.reinman@yahoo.com',
                password: '123456',
                data: 'eyJhY2NvdW50IjoiZWtpcmkiLCJuYW1lIjoiYW5kcmlzIiwicmVkaXJlY3RVcmwiOiIvYWRtaW4vYWNjb3VudHMifQ',
                sig: 'p2J3XHb6ArcBKyKcHT5BPvtnPPGiy_PwJJBW1Bkb_aE',
                imap_host: 'imap.mail.yahoo.com',
                imap_port: 993,
                imap_secure: true,
                imap_auth_user: 'andris.reinman@yahoo.com',
                smtp_host: 'smtp.mail.yahoo.com',
                smtp_port: 465,
                smtp_secure: true,
                smtp_auth_user: 'andris.reinman@yahoo.com',
                _source: 'mozilla'
                }
            */
