                ...
                'internals/index',
                {
                    ...
                    threads: threads.map(threadInfo => {
                        ...
                        if (threadInfo.resourceUsageError) {
                            ...
                            threadInfo.heapRelative = '-';
                            threadInfo.heapMax = '-';
                            threadInfo.errorMessage = threadInfo.resourceUsageError.error;
                        }

                        // Process CPU percentage and mark high CPU usage
                        if (threadInfo.cpuPercent !== null && threadInfo.cpuPercent !== undefined) {
                            threadInfo.cpuPercent = threadInfo.cpuPercent.toFixed(1);
                            // Mark as high CPU if above 80%
                            if (parseFloat(threadInfo.cpuPercent) > 80) {
                                threadInfo.isHighCpu = true;
                            }
                        }
