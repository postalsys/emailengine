    ...
    server.route({
        ...
        async handler(request, h) {
            try {
                let data = {};
                if (
                    request.payload.gmailSubscriptionTtl === '' ||
                    request.payload.gmailSubscriptionTtl === null ||
                    request.payload.gmailSubscriptionTtl === undefined
                ) {
                    data.gmailSubscriptionTtl = null;
                } else {
                    data.gmailSubscriptionTtl = request.payload.gmailSubscriptionTtl;
                }
