...
const oauth2Schema = {
    ...
    authority: Joi.string()
        ...
        .max(1024)
        .example('consumers')
        .description("Outloook account type. Either 'consumers', 'organizations', 'common' or an organization ID")
...
const mailboxesSchema = Joi.array()
    .items(
        Joi.object({
            ...
            name: Joi.string().required().example('Sünnipäevad').description('Mailbox name').label('MailboxName'),
