...
// error cases. hapi-swagger derives a 200 entry from the route's response.schema but
// labels it only "Successful", and for a raw stream or binary body it derives nothing at
// all - so the description is stated here. It is documentation only and never affects
// request processing.
//
