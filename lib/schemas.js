...
const settingsSchema = {
    ...
    openAiMaxTokens: Joi.number()
        ...
        .min(0)
        .example(3000)
        .description('Maximum tokens limit for OpenAI API requests (defaults: GPT-4: 6500, GPT-3.5: 3000)')
...
const oauth2Schema = {
    ...
    authority: Joi.string()
        ...
        .max(1024)
        .example('consumers')
        .description('Microsoft account type: "consumers" (personal), "organizations" (work/school), "common" (both), or a specific tenant ID')
...
const attachmentSchema = Joi.object({
    ...
    encodedSize: Joi.number()
        .integer()
        .example(48)
        .description('Size of the attachment in bytes as stored (base64 encoded size, actual file size will be smaller)'),
