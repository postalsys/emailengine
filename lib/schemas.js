...
const searchSchema = Joi.object({
    ...
    emailIds: Joi.array()
        ...
        .single()
        .description(
            'List of email IDs when using API backends. This will set email IDs explicitly and other search arguments are ignored. Use this when you want to apply something for a known list of emails.'
        )
        .example(['1278455344230334865'])
        .label('EmailIds')
})
