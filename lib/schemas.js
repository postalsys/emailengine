...
const settingsSchema = {
    ...
    imapIndexer: Joi.string()
        ...
        .meta({ enumDescriptions: ENUM_DESCRIPTIONS.imapIndexer })
        .label('ImapIndexer'),
    ...
    openAiAPIUrl: Joi.string()
        ...
        .description(
            'Base URL for the OpenAI API. Set for OpenAI-compatible services, including any URL path the service mounts the API under - for Azure OpenAI, use https://<your-resource>.openai.azure.com/openai/v1'
        )
        .label('OpenAiAPIUrl'),
...
const imapSchema = {
    auth: Joi.object({
        ...
        .description(
            'Authentication credentials for the IMAP server. Not used when `useAuthServer` is enabled - the credentials are fetched from the authentication server instead, and this must be omitted or `false`.'
        )
    ...
    disableIMAP4rev2: Joi.boolean()
        .example(false)
        .description(
            'Do not use IMAP4rev2 even if the server supports it. Set this for servers with a broken IMAP4rev2 implementation. Only applies to accounts using regular password authentication.'
        ),
...
const smtpSchema = {
    auth: Joi.object({
        ...
        .description(
            'Authentication credentials for the SMTP server. Not used when `useAuthServer` is enabled - the credentials are fetched from the authentication server instead, and this must be omitted or `false`.'
        )
