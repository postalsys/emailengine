...
const settingsSchema = {
    webhooksDisabled: Joi.boolean().truthy('Y', 'true', '1').falsy('N', 'false', 0).description('If true then do not emit webhooks'),
...
const licenseSchema = Joi.object({
    ...
    details: Joi.object({
        ...
        hostname: Joi.string().hex().example('emailengine.example.com').description('Hostname or environment this license applies to'),
