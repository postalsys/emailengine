...
const settingsSchema = {
    ...
    smtpServerProxy: Joi.boolean().truthy('Y', 'true', '1', 'on').falsy('N', 'false', 0, '').description('Enable PROXY Protocol'),
    smtpServerAuthEnabled: Joi.boolean().truthy('Y', 'true', '1', 'on').falsy('N', 'false', 0, '').description('Enable authentication'),
    smtpServerPassword: Joi.string().empty('').max(1024).required().description('SMTP client password')
};
