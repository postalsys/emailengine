...
const templateSchemas = {
    ...
    htmlTemplate: Joi.object()
        .keys({
            format: Joi.string().empty('').valid('html', 'markdown', 'mjml').default('html').description('Template format').label('HtmlTemplateFormat'),
