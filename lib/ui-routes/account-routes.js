...
const { formatAccountData, cachedTemplates, identityErrorView, ACCOUNT_STATE_DISPLAY, adminUrl, accountSuggestions } = require('./route-helpers');
...
function init(args) {
    ...
    server.route({
        ...
        async handler(request, h) {
            ...
            // API call.
            const authFailureDisabledAt = accountData._authFailureDisabledAt || null;
            ...
            return h.view(
                'accounts/account',
                {
                    ...
                    account: accountData,
                    accountAlert,
                    accountParked: !!authFailureDisabledAt,
                    logs: logInfo,
