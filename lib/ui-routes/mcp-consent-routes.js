...
const { MCP_ACCESS_LEVELS, MCP_ACCESS_LEVEL_OPTIONS } = tokenPermissionView;
    ...
    async function renderConsent(h, { client, redirectUri, canProvision, values, errors }) {
        ...
        return h.view(
            'mcp/authorize',
            {
                ...
                readGrantGroups: MCP_ACCESS_LEVELS.read.groups.join(', '),
                mailGrantGroups: MCP_ACCESS_LEVELS.mail.groups.join(', '),
