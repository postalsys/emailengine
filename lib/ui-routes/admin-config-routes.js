...
const { assertAllowedUrl, normalizePolicy, POLICY_OFF } = require('../egress-filter');
...
// Must match the policy the webhooks worker enforces on real deliveries, including the null that
// tells sendWebhookRequest to keep following redirects when the policy is off
