...
const { MCP_READ_ONLY_PERMISSIONS } = require('../token-permission-view');
    ...
    registerSettingsPage(server, {
        ...
        async viewContext(request) {
            ...
            return {
                ...
                toolCatalog,
                accountOptions,
                // What the generator's "Read-only" mode narrows a token to. Full access is the
                // absence of a permissions record, the same shape the OAuth consent mint issues
                mcpTokenPresets: { readOnly: MCP_READ_ONLY_PERMISSIONS },
