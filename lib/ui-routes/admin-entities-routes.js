        ...
        async handler(request, h) {
            ...
            return h.view(
                'tokens/new',
                {
                    ...
                    mcpTools,
                    // The same three access levels the OAuth consent prompt and the MCP config
                    // page offer, from the same table, rendered through the same partial. An
                    // mcp-scoped token is minted from three places and the levels have to mean
                    // the same thing in all of them.
                    accessOptions: tokenPermissionView.MCP_ACCESS_LEVEL_OPTIONS,
                    mcpAccessPresets: tokenPermissionView.MCP_ACCESS_LEVELS,
