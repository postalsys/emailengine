...
// The narrowing the MCP token generator's "Read-only" mode applies, derived once at load from
// the same table the scope enforcement reads: the read grants of the mcp surface, nothing else.
// Lives here rather than on the page that posts it because this module owns how permission
// records are presented, and a second derivation had already drifted (all groups instead of the
// readable ones).
...
module.exports = { formModel, summarize, ACTION_LABELS, GROUP_LABELS, MCP_READ_ONLY_PERMISSIONS };
