...
function summarize(permissions) {
    if (!permissions || typeof permissions !== 'object' || Array.isArray(permissions)) {
        // A non-object here is a record the API could not have written. Surfaced as unreadable rather
        // than as "not restricted", because lib/token-permissions.js denies every request such a
        // token makes and the list would otherwise show it as a working credential.
        return permissions ? { actions: null, groups: null, unreadable: true } : null;
    }
