...
const { metricsMeta, markRejectedAccessToken, renewRejectedAccessToken, isTransientNetworkError } = require('../base-client');
...
async function request(context, url, method, payload, options = {}) {
    ...
    for (let attempt = 0; attempt <= maxRetries; attempt++) {
        ...
        try {
            ...
            result = await context.oAuth2Client.request(tokenData.accessToken, url, method, payload, options);
