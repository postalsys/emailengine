...
// OAuth2 credential sources (EmailEngine's own token refresh and an external authentication server)
// use this to avoid reporting an unreachable host as an authentication error, which would webhook
// and park every account on the instance over a brief outage.
...
function isTransientNetworkError(err) {
    return !!err && TRANSIENT_CONNECT_CODES.has(err.code);
}
...
module.exports = { BaseClient, metricsMeta: postMetrics, applyReferenceRecipients };
