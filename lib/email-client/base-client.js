...
class BaseClient {
    ...
    mightBeABounce(messageData) {
        ...
        if (/^Undeliverable\s+Message$|Mail delivery failed|Delivery Status Notification|Returned mail|Failure Notice|error sending your mail/i.test(messageData.subject)) {
            return true;
        }
