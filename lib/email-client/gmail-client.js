    ...
    async getTokenData() {
        ...
        try {
            ...
            if (!['init', 'connecting', 'connected'].includes(this.state)) {
                ...
                // But we just got a valid token, so we've recovered. Announced here as well as in
                // init(), because this is a recovery in its own right - and it is what clears the
                // stored error state, which would otherwise outlive the error it describes
