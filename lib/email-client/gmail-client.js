...
class GmailClient extends BaseClient {
    ...
    async submitMessage(data) {
        ...
        if (raw.length <= JSON_SEND_LIMIT) {
            ...
            // Large message: upload endpoint with raw RFC822 Buffer
            // Threading for large replies relies on RFC822 headers (In-Reply-To,
            // References, Subject) which Gmail uses for automatic thread matching
