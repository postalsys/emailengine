...
const { buildSendRequest } = require('./gmail/send-request');
...
class GmailClient extends BaseClient {
    ...
    async submitMessage(data) {
        ...
        // Endpoint, content type and payload encoding all depend on the message size and on
        // whether it belongs to a thread - see lib/email-client/gmail/send-request.js
        const { targetEndpoint, contentType, payload } = buildSendRequest(raw, data?.reference?.threadId);
