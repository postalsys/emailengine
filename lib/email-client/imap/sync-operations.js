...
const { connectionClosedError, connectionNotAvailableError } = require('./connection-errors');
...
class SyncOperations {
    ...
    async runFastSync() {
        ...
        try {
            ...
            // sync of this folder that ran just ahead of this one. Neither is accepted from
            // the caller for that reason - onOpen() reads its own copy before the lock, to
            // pick a strategy from, and a sync ahead of this one in the lock queue leaves
            // that copy behind
