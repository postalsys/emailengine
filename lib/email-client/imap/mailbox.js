...
class Mailbox {
    ...
    async processNew(messageData, options, canSync, storedStatus) {
        ...
        if (this.connection.mightBeAComplaint(messageInfo)) {
            try {
        ...
        if (this.connection.mightBeDSNResponse(messageInfo)) {
            try {
        ...
        if (this.connection.mightBeABounce(messageInfo)) {
    ...
    /**
     * Fetches complete message details. Every message it returns carries `messageSpecialUse`,
     * which the arrival checks in processNew() and the fetch-time bounce check gate on
     * @param {Object} message - Message object with uid
     * @param {Object} options - Fetch options
     * @param {Object} connectionOptions - Connection options
