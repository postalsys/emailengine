...
class Mailbox {
    ...
    async onOpen() {
        ...
        try {
            ...
            // Lost-index recovery: the account has synced in a previous session but this folder's
            // stored state is gone (e.g. Redis evicted it) while the server still has messages.
            // Rebuild the index silently instead of replaying every message as a new email.
