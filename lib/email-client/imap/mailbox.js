...
class Mailbox {
    ...
    mightBeABounce(messageInfo) {
        ...
        if (/^Undeliverable\s+Message$|Mail delivery failed|Delivery Status Notification|Returned mail|Failure Notice|error sending your mail/i.test(messageInfo.subject)) {
            return true;
        }
