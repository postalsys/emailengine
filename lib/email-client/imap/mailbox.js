    ...
    async sync(forceEmpty) {
        ...
        try {
            ...
            if (err.responseStatus === 'NO') {
                // The folder is listed but can not be selected (e.g. a shared namespace
                // root that the server lists without \Noselect). Skip it instead of
                // failing the entire account sync. Transient errors do not have
