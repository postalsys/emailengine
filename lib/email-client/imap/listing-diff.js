 ...
 *
 * The shape check is not redundant with the try/catch. msgpack5 only throws on input it can not
 * parse at all - a corrupt buffer whose first byte happens to be a valid type marker decodes to
