...
class IMAPClient extends BaseClient {
    ...
    async setupSubConnections() {
        ...
        for (let i = this.subconnections.length - 1; i >= 0; i--) {
            ...
            // Disabled entries can be placeholder objects without a close method
    ...
    closeSubconnections() {
        ...
        for (let subconnection of subconnections) {
            // Disabled entries can be placeholder objects without a close
            // method, while a disabled live instance still needs the cleanup
            if (typeof subconnection.close === 'function') {
                try {
                    subconnection.removeAllListeners();
                    subconnection.close();
