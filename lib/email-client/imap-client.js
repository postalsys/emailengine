    ...
    async getImapConfig(accountData, ctx) {
        ...
        if (await useAuthServerForConnection(imapConnectionConfig, ctx.logger, { account: this.account, target: 'imap' })) {
            try {
                ...
                ctx.logger.error({
                    msg: 'Failed to resolve credentials from authentication server',
                    err
                });
    ...
    async start() {
        ...
        try {
            ...
            try {
                ...
                let isInitial = !!isFirstSuccessfulConnection;
                ...
                if (isFirstSuccessfulConnection) {
                    ...
                    this.logger.info({ msg: 'Successful login with a previous active session', account: this.account, isInitial, prevActive: true });
                }
