...
class IMAPClient extends BaseClient {
     ...
     * sync emits the mailboxNew notification, so every getCurrentListing() result
     * must be routed through here - the returned listing is the only carrier of
     * the flag (it is dropped from the persisted listing on purpose).
