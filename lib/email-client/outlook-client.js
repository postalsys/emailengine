...
class OutlookClient extends BaseClient {
    ...
    async init() {
        ...
        let { hasSendScope, hasReadScope } = checkAccountScopes('outlook', scopes, this.logger);
        ...
        if (this.oAuth2Client && this.oAuth2Client.useClientCredentials) {
            hasSendScope = true;
            hasReadScope = true;
        }
    ...
    async prepareDelegatedAccount() {
        ...
        if (oauth2App && oauth2App.provider === 'outlookService') {
