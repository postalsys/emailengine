...
class OutlookClient extends BaseClient {
    ...
    async submitMessage(data) {
        ...
        // Three delivery shapes: an existing draft is sent via /messages/{id}/send, otherwise
        // the message goes through /sendMail as raw MIME (default - preserves calendar invites
        // and special MIME types) or as a structured JSON message (opt-in - respects the from
        // field for shared mailboxes)
        if (data.draft) {
