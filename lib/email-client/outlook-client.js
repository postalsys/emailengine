...
class OutlookClient extends BaseClient {
    ...
    async ensureSubscription() {
        ...
        let notificationBaseUrl = ((await settings.get('notificationBaseUrl')) || serviceUrl || '').replace(/\/$/, '');
        ...
        if (!outlookSubscription.id) {
            ...
            const subscriptionPayload = {
                ...
                notificationUrl: `${notificationBaseUrl}/oauth/msg/notification?${queryArgs}`,
                lifecycleNotificationUrl: `${notificationBaseUrl}/oauth/msg/lifecycle?${queryArgs}`,
