...
//
// The autodiscovery lookups (lib/autodetect-imap-settings.js) apply the same policy: their
// destinations are derived from the domain of a caller-supplied email address, which a DNS record
// can point anywhere. One policy rather than two because they guard the same thing, the host's
// network position, and an operator who tuned it for webhooks meant the tuning for all egress.
