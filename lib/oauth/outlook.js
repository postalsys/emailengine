...
const OUTLOOK_SCOPES = {
    ...
    api: ['https://graph.microsoft.com/Mail.ReadWrite', 'https://graph.microsoft.com/Mail.Send', 'offline_access', 'openid', 'profile', 'User.Read']
};
...
class OutlookOauth {
    constructor(opts) {
        const defaultBaseScopes = (opts.baseScopes && OUTLOOK_SCOPES[opts.baseScopes]) || OUTLOOK_SCOPES.imap;
