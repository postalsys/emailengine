...
// Webhook deliveries are the one outbound path whose destination the operator supplies, so they
// get a dispatcher that resolves through the egress policy (lib/webhook-egress.js) rather than the
// shared resolver. It is built here because its lifetime is tied to the other agents': a proxy
// setting change swaps them all out together.
//
