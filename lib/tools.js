...
function buildWebhookDispatcher(proxied, existing) {
    ...
    return existing || new RetryAgent(new Agent(Object.assign({}, AGENT_OPTS, { connect: { lookup } })), RETRY_OPTS);
}
...
async function _doReloadHttpProxyAgent() {
    ...
    let oldWebhook = httpAgent.webhook !== httpAgent.retry ? httpAgent.webhook : null;
    ...
    try {
        ...
        logger.info({
            ...
            webhookEgressPinned: httpAgent.webhook !== httpAgent.retry
        });
