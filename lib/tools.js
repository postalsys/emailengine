...
`
    ...
    threadStats: {
        ...
        usage() {
            ...
            // Calculate CPU percentage if we have previous measurements
            if (this.previousCpuUsage && this.previousTimestamp) {
                ...
                if (timeDelta > 0) {
                    ...
                    const userDelta = (currentCpuUsage.user - this.previousCpuUsage.user) / 1000;
                    const systemDelta = (currentCpuUsage.system - this.previousCpuUsage.system) / 1000;
                    const totalCpuTime = userDelta + systemDelta;

                    // Calculate percentage (totalCpuTime/timeDelta gives us the fraction of CPU used)
                    cpuPercent = (totalCpuTime / timeDelta) * 100;

                    // Cap at 100% (can exceed on multi-core systems if not normalized)
            ...
            return Object.assign({}, heapStats, {
