...
// Network utilities (re-exported for backward compatibility)
const { resolvePublicInterfaces, updatePublicInterfaces, getLocalAddress, matchIp, detectAutomatedRequest, googleCrawlerMap } = require('./utils/network');
...
`
    ...
    // Network utilities (re-exported from lib/utils/network.js)
