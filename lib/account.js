...
class Account {
    ...
    async delete(opts) {
        ...
        if (opts.revoke && accountData.oauth2 && accountData.oauth2.provider && accountData.oauth2.accessToken) {
            try {
                ...
                if (oauthClient && typeof oauthClient.revokeToken === 'function') {
                    await oauthClient.revokeToken(accountData.oauth2.accessToken);
                }
            } catch (err) {
