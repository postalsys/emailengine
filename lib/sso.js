...
// Normalize the OIDC `email_verified` claim to a strict tri-state. The spec says it
// is a boolean, but some IdPs emit the string "true"/"false"; anything else -
// including a missing claim - stays undefined so callers can tell an explicitly
// unverified address ("unverified") apart from an IdP that never asserts it ("unknown").
